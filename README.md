[![License](https://img.shields.io/github/license/SumuduLansakara/JustBash)](https://github.com/SumuduLansakara/JustBash/blob/master/LICENSE)
...
[![Stars](https://img.shields.io/github/stars/SumuduLansakara/JustBash?style=social)](https://github.com/SumuduLansakara/JustBash/stargazers)
[![Watchers](https://img.shields.io/github/watchers/SumuduLansakara/JustBash?style=social)](https://github.com/SumuduLansakara/JustBash/watchers)
...
> **Example:**
> ```
> ./jb.sh -i instance1 -c demoArtist
> ```
...
> **Example:**
> ```
> ./jb.sh -c demoArtist -i instance1
> ```
...
Implement the script content, using *JustBash* framework capabilities where needed.
...
\    Y    /\  ___/ |  |__|  |__(  <_> )     \        / (  <_> ) |  | \/|  |__/ /_/ |  \|
 \___|_  /  \___  >|____/|____/ \____/       \__/\  /   \____/  |__|   |____/\____ |  __
       \/       \/                                \/                              \/  \/
[wrn] input arguments: arg_1 arg_2
```

> **Hints:**
> - Refer to demo scripts in the `scripts` directory for more usage examples.
